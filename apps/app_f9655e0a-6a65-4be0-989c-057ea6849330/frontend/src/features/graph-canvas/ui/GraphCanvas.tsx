...
export const GraphCanvas = React.memo<GraphCanvasProps>(({
  ...
  const getMousePosition = React.useCallback((e: React.MouseEvent): CanvasPosition => {
  ...
  const handleNodeMove = React.useCallback((nodeId: string, position: CanvasPosition) => {
  ...
  return (
    ...
    >
      ...
      <g className="edges">
        ...
        {tempEdge && (() => {
          const sourceNode = graph.nodes.find(n => n.id === tempEdge.sourceId);
