              ...
              <div className="flex-1 flex flex-col items-center space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 max-w-sm">
                    Click or hover over the color wheel to explore different
                    colors
                  </p>
                </div>
              ...
              <div>
                ...
                <ul className="text-sm text-blue-700 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Hover over the color picker to see interactive crosshairs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 font-bold">•</span>
                    <span>
                      Selected colors are displayed with live preview in the
                      swatch
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 font-bold">•</span>
                    <span>
                      Color values are shown in hexadecimal format for easy
                      copying
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-500 font-bold">•</span>
                    <span>
                      Fully accessible with keyboard navigation and screen
                      reader support
                    </span>
                  </li>
                </ul>
