...
async function generateApiTypes() {
  try {
    ...
    const { schemas, paths } = specsModule as {
    ...
    console.log(`📊 Combined ${specExports.length} OpenAPI spec files`);
  } catch (error) {
